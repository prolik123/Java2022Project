...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "proj/proj.App"
...
@rem Execute project
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PROJECT_OPTS%  -classpath "%CLASSPATH%" --module-path "%MODULE_PATH%" --module proj/proj.App %*
...
if not ""=="%PROJECT_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
